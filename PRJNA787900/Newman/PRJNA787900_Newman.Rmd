...
deseq_volcano_c_i <- function(t) {
  ...
  cols <- c("0_control_1", "0_control_2", "0_control_3",
...
plot2 + plot5 + plot10 + plot20 + plot30 + plot_layout(nrow = 2) 
```
