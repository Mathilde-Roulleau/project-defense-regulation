...
```{r}
# We remove Late Infection_3, Late Infection_4, Middle Infection_3 and Middle Infection_4
# because less than 40% of bacterial genes detected
cnt_matrix <- cnt_matrix %>%
  select(-`Late Infection_3`, -`Late Infection_4`,
         -`Middle Infection_3`, -`Middle Infection_4`)
```
